...
${OBJECTDIR}/Logins.o: Logins.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Logins.o Logins.cpp
...
${OBJECTDIR}/SharedData.o: SharedData.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SharedData.o SharedData.cpp

${OBJECTDIR}/Sockets.o: Sockets.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sockets.o Sockets.cpp
...
${OBJECTDIR}/table/root/NetBeansProjects/semPOS/nbproject/Makefile-Debug.mk.o: table.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
